...
* 2. [响应式编程规范](#-1)
	...
	* 2.3. [基本概念](#-1)
* 3. [RxJava 基础](#RxJava)
	* 3.1. [RxJava现状](#RxJava-1)
	* 3.2. [RxJava2 优势](#RxJava2)
		* 3.2.1. [与其它编程模式/库相比](#-1)
		* 3.2.2. [RxJava 1 vs RxJava 2](#RxJava1vsRxJava2)
	* 3.3. [RxJava2中的响应式类](#RxJava2-1)
		* 3.3.1. [RxJava2 主要类关系图](#RxJava2-1)
		* 3.3.2. [Flowable & Observable](#FlowableObservable)
		* 3.3.3. [2.3.2  Single & Completable & Maybe](#SingleCompletableMaybe)
* 4. [RxJava2 的主要操作](#RxJava2-1)
	* 4.1. [创建一个Flowable](#Flowable)
	* 4.2. [转换、过滤与聚合操作](#-1)
	* 4.3. [异步与并发（Asynchronized & Concurrency）](#AsynchronizedConcurrency)
		* 4.3.1. [observeOn & subscribeOn & Scheduler](#observeOnsubscribeOnScheduler)
		* 4.3.2. [多线程并发示例](#-1)
		* 4.3.3. [阻塞与非阻塞示例](#-1)
	* 4.4. [错误处理 (Error Handling)](#ErrorHandling)
	* 4.5. [冷热数据流](#-1)
		* 4.5.1. [ ConnectableFlowable & publish & connect](#ConnectableFlowablepublishconnect)
		* 4.5.2. [replay](#replay)
		* 4.5.3. [cache](#cache)
	* 4.6. [RxJava 测试](#RxJava-1)
* 5. [Reference](#Reference)

<!-- /vscode-markdown-toc -->响应式编程实践
============
...
###  1.1. <a name='ReactiveProgramming'></a>什么是响应式编程(Reactive Programming)

- 响应式编程是一种面向数据流和变化传播的编程范式。这意味着可以在编程语言中很方便地表达静态或动态的数据流，而相关的计算模型会自动将变化的值通过数据流进行传播。

###  1.2. <a name='-1'></a>响应式宣言
...
##  2. <a name='-1'></a>响应式编程规范

###  2.1. <a name='-1'></a>响应式流规范
...
##  3. <a name='RxJava'></a>RxJava 基础

###  3.1. <a name='RxJava-1'></a>RxJava现状
...
###  3.2. <a name='RxJava2'></a>RxJava2 优势

####  3.2.1. <a name='-1'></a>与其它编程模式/库相比
...
####  3.2.2. <a name='RxJava1vsRxJava2'></a>RxJava 1 vs RxJava 2
...
###  3.3. <a name='RxJava2-1'></a>RxJava2中的响应式类

####  3.3.1. <a name='RxJava2-1'></a>RxJava2 主要类关系图
...
####  3.3.2. <a name='FlowableObservable'></a>Flowable & Observable
...
####  3.3.3. <a name='SingleCompletableMaybe'></a>2.3.2  Single & Completable & Maybe
...
##  4. <a name='RxJava2-1'></a>RxJava2 的主要操作
...
###  4.1. <a name='Flowable'></a>创建一个Flowable
...
###  4.3. <a name='AsynchronizedConcurrency'></a>异步与并发（Asynchronized & Concurrency）
RxJava 通过一些操作统一了 同步和异步，阻塞与非阻塞，并行与并发编程。


####  4.3.1. <a name='observeOnsubscribeOnScheduler'></a>observeOn & subscribeOn & Scheduler
...
###  4.4. <a name='ErrorHandling'></a>错误处理 (Error Handling)
...
###  4.5. <a name='-1'></a>冷热数据流

####  4.5.1. <a name='ConnectableFlowablepublishconnect'></a> ConnectableFlowable & publish & connect 
...
###  4.6. <a name='RxJava-1'></a>RxJava 测试
